...
OWNER_USERNAME = getenv("OWNER_USERNAME", "ᴄʙᴜᴍ 👾")
BOT_USERNAME = getenv("BOT_USERNAME", "CbumMusicPlayerBot")
BOT_NAME = getenv("BOT_NAME", "˹ᴄʙᴜᴍ ✘ ᴍᴜsɪᴄ˼ ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "Nova Legacy")
...
# ── Git / updates ──────────────────────────────────────────────────────────────
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/cbum23/TelegramMusicBot")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN")  # needed if repo is private

# ── Support links ──────────────────────────────────────────────────────────────
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/irlxviikram")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/pychats")
